    ...
    <div class="shop_detail">
        ...
        <section class="activities_container">
            ...
            <ul class="activities_ul">
                <li v-for="activity in shopDetail.activities" :key="activity.id">
        ...
        <section class="shop_status_info">
            ...
            <p @click="showLicenseImgFn(shopDetail.license.business_license_image)">
                <span>营业执照</span>
                <svg width="14" height="14" xmlns="http://www.w3.org/2000/svg" version="1.1" class="description_arrow" >
                    <path d="M0 0 L8 7 L0 14"  stroke="#bbb" stroke-width="1.5" fill="none"/>
                </svg>
            </p>
            <p @click="showLicenseImgFn(shopDetail.license.catering_service_license_image)">
                <span>餐饮服务许可证</span>
                <svg width="14" height="14" xmlns="http://www.w3.org/2000/svg" version="1.1" class="description_arrow" >
                    <path d="M0 0 L8 7 L0 14"  stroke="#bbb" stroke-width="1.5" fill="none"/>
                </svg>
